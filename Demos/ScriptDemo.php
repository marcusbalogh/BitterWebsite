...
<br /><br />
<p><b>
        <font color="#ff0000">Step 1 : A simple product display using HTML</font>
    </b></p>
...
<br /><br /><br />
<p><b>
        <font color="#ff0000">Step 2 : The next 7 products are displayed by scripting:</font>
    </b></p>
<br><br>
...
<br /><br /><br />
<p><b>
        <font color="#ff0000">Step 3 : The next ??? products are generated by scripting, bringing content in from the
            database ProductsDemo.
            <br />Only certain records (Tools category) will be displayed!</font>
    </b></p>
...
// "Retrieve Desired Record Set"
	...
	$strSQL = "SELECT ID, 
            ...
            Option2c,
            Option2d 
            FROM Products WHERE Category = '$strCategory' ORDER BY ID";
...
<?php /*CODE THAT MAKES THINGS BLOOP BLOOP from the database*/
	...
	//	  Keep that in mind for future exercises.
	   ...
	   echo '
		...
		// Change to be dynamic, from database.
                ...
                /*GOOD FOR DEBUGGING    PRINT_R($rowProd)*/
		if ( $rowProd["Option1desc"] != "" )// only if Option1Desc is not empty
                {
                    //check field in and display if is not null
                    $o1a='';
                    $o1b='';
                    $o1c='';
                    $o1d='';
                    if ( $rowProd["Option1a"] != "" ){
			$o1a='<li>' . $rowProd["Option1a"] . '</li>';
                    }
                    if ( $rowProd["Option1b"] != "" ){
			$o1b='<li>' . $rowProd["Option1b"] . '</li>';
                    }
                    if ( $rowProd["Option1c"] != "" ){
			$o1c='<li>' . $rowProd["Option1c"] . '</li>';
                    }
                    if ( $rowProd["Option1d"] != "" ){
			$o1d='<li>' . $rowProd["Option1d"] . '</li>';
                    }
		...
		if ( $rowProd["Option2Desc"] != "" ) {
                    ...
                    $o2d='';	
                    if ( $rowProd["Option2a"] != "" ){
			$o2a='<li>' . $rowProd["Option2a"] . '</li>';
                    }
                    if ( $rowProd["Option2b"] != "" ){
			$o2b='<li>' . $rowProd["Option2b"] . '</li>';
                    }
                    if ( $rowProd["Option2c"] != "" ){
			$o2c='<li>' . $rowProd["Option2c"] . '</li>';
                    }
                    if ( $rowProd["Option2d"] != "" ){
			$o2d='<li>' . $rowProd["Option2d"] . '</li>';
                    }
                    echo '
				<br clear=all /><br />
